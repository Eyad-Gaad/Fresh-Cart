...
export const routes: Routes = [
    ...
    {path:'change-password',loadComponent:()=>import('./features/auth/change-password/change-password.component').then(component=>component.ChangePasswordComponent),title:'change-password',canActivate:[authGuard]},
    ...
    {path:'brand/:brandName/:bId',loadComponent:()=>import('./features/pages/brand/brand.component').then(component=>component.BrandComponent),title:'brand'},
