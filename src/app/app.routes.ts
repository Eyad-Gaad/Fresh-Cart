...
export const routes: Routes = [
    ...
    {path:'**',loadComponent:()=>import('./features/layout/not-found/not-found.component').then(component=>component.NotFoundComponent),title:'page not found',canActivate:[authGuard]}
];